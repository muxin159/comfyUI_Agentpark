...
from .nodes.websocket_handler import websocket_handler  # 确保导入 WebSocket 处理器
from .nodes.chat_server import config_manager  # 导入配置管理器
...
def monitor_servers():
    ...
    while True:
        ...
        if chat_server_process and chat_server_process.poll() is not None:
            ...
            chat_server_process = start_server("nodes/chat_server.py", 8166)
